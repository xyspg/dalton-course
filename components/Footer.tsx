...
const getActiveUsers = async () => {
  ...
  const response = await fetch("https://analytics.xyspg.moe/api/websites/2d67dea1-d9b6-46a6-bcde-02f612591fdf/active", requestOptions)
